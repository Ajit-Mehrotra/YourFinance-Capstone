        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden"
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                <li class="items-center">
                    <a class="{{ request()->is('dashboard_test') ? $active : '' }}  text-xs uppercase py-3 font-bold block"
                        href="dashboard_test"><i class="fas fa-tv opacity-75 mr-2 text-sm"></i>
                        Your Current Situation</a>
                </li>
                <li class="items-center">
                    <a class="{{ request()->is('improve') ? $active : '' }} text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="improve"><i class="fas fa-newspaper text-blueGray-400 mr-2 text-sm"></i>
                        Where to Improve</a>
                </li>
                <li class="items-center">
                    <a class="{{ request()->is('execution') ? $active : '' }} text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
            ...
            <ul>
                ...
                <li class="items-center">
                    <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="#/login"><i
                            class="{{ request()->is('money-management') ? $active : '' }} fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
                ...
                <li class="items-center">
                    <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="#/login"><i
                            class="{{ request()->is('predective-analysis') ? $active : '' }} fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
                ...
                <li class="items-center">
                    <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="#/login"><i
                            class="{{ request()->is('money-distribution') ? $active : '' }} fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
                        Auto Money Distribution
                    </a>
                </li>
                <li class="items-center">
                    <a class="text-blueGray-300 text-xs uppercase py-3 font-bold block" href="#pablo"><i
                            class=" {{ request()->is('investment-analytics') ? $active : '' }} fas fa-clipboard-list text-blueGray-300 mr-2 text-sm"></i>
                        Investments Analytics</a>
                </li>
                <li class="items-center">
                    <a class="text-blueGray-300 text-xs uppercase py-3 font-bold block" href="#pablo"><i
                            class="{{ request()->is('planning') ? $active : '' }} fas fa-tools text-blueGray-300 mr-2 text-sm"></i>
                        Planning (soon)</a>
                </li>
            </ul>
            <hr class="my-4 md:min-w-full" />
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
                <li class="items-center">
                    <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="/plaid"><i
                            class="{{ request()->is('link') ? $active : '' }} fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
                        See Linked Accounts
                    </a>
                </li>
                <li class="items-center">
                    <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="#/login"><i
                            class="{{ request()->is('import') ? $active : '' }} fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
                ...
                <li class="items-center">
                    <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="#/login"><i
                            class="{{ request()->is('suggest') ? $active : '' }} fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
                        Suggest A Feature
                    </a>
                </li>
                <li class="items-center">
                    <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="#/login"><i
                            class="{{ request()->is('bug') ? $active : '' }} fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
                        Report a bug
                    </a>
                </li>
